        ...
        for(Brick b : bricks){
            switch (b.findImpact(ball)) {
                ...
                case Brick.UP_IMPACT -> {
                    ball.reverseY();
                    return b.setImpact(ball.getDown(), Brick.Crack.getUP());
                }
                case Brick.DOWN_IMPACT -> {
                    ball.reverseY();
                    return b.setImpact(ball.getUp(), Brick.Crack.getDOWN());
                }

                //Horizontal Impact
                case Brick.LEFT_IMPACT -> {
                    ball.reverseX();
                    return b.setImpact(ball.getRight(), Brick.Crack.getRIGHT());
                }
                case Brick.RIGHT_IMPACT -> {
                    ball.reverseX();
                    return b.setImpact(ball.getLeft(), Brick.Crack.getLEFT());
                }
            }
        }
        return false;
